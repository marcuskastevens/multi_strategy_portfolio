...
class dasr_optimized_long_only_portfolio():
    ...
    def max_dasr_optimization(self, returns: pd.DataFrame) -> pd.Series:
        ...
        # Long Only Weights Constraint SUM(w) <= 100%
        # Allows for no exposure if system decides it is necessary (will limit drawdowns)
        constraints =  [
